...
def main():
    ...
    with open("summary-base.qsf", 'r') as f:
        qualtric_obj = json.load(f)

        qualtric_obj["SurveyEntry"]["SurveyName"] = "summary-control"

        # clear out the existing surveys
        qualtric_obj['SurveyElements'][1]["Payload"]["Flow"][1]['Flow'] = []
        qualtric_obj['SurveyElements'][1]["Payload"]["Flow"][1]['SubSet'] = 6
        ...
        with open("summary-base-e.qsf", 'w') as f:
