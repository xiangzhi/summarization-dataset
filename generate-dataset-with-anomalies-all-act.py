...
if __name__ == "__main__":
    ...
    for type_ in ["test", "train", "valid"]:
        ...
        for persona in ["persona4", "persona-all"]:
            ...
            abnormal_data = {
                "start_time_mean" : datetime.datetime.strptime("01:00", "%H:%M"),
                "start_time_std" : datetime.timedelta(minutes=10),
                "duration_mean" : datetime.timedelta(minutes=90),
                "duration_std" : datetime.timedelta(minutes=30),
            }
            ...
            for i, line in enumerate(lines):
                ...
                if (routine._day+1)%7 != 0 and routine._day%7 != 0:
                    ...
                    routine.add_activity("taking_medication", start_time, duration=duration, anomalous=(i in anomaly_idx), anomaly_reason=("because the resident usually work around 15:00" if i in anomaly_idx else ""))
